...
def student_init():
    ...
    stud8 = Student(10675891,"Jerry","Benn",21, list_of_majors[3])

    stud6 = Student(10628415, "Lynn","Nzouadja-Keundo",19, list_of_majors[1])

    list_of_active_students.extend([stud1,stud2,stud3,stud4,stud5,stud6,stud8])
